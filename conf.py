...
BLOG_AUTHOR = "A. Sean Pue"  # (translatable)
BLOG_TITLE = "A. Sean Pue"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://seanpue.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://seanpue.com/"
BLOG_EMAIL = "a@seanpue.com"
BLOG_DESCRIPTION = "This is the webpage of A. Sean Pue."  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ...
        # ('/blog', 'Blog'),
        ('/cv','C.V.'),
        ('/itoohavesomedreams','<i>I Too Have Some Dreams</i>'),
