...
BLOG_AUTHOR = "A. Sean Pue"
BLOG_TITLE = "A. Sean Pue"
# This is the main URL for your site. It will be used
# in a prominent link
SITE_URL = "http://seanpue.com/"
# This is the URL where nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://getnikola.com/"
BLOG_EMAIL = "a@seanpue.com"
BLOG_DESCRIPTION = "This is the blog of A. Sean Pue."
...
#    ("pages/*.txt", "", "story.tmpl"),
     ...
     #(#"cv/*.rst", "cv", "story.tmpl"), # could easily add custom CV template
)
...
#CONTENT_FOOTER = """<div id="shareNice" data-share-label="Share"
...
# added from: http://getnikola.com/social_buttons.html

#SOCIAL_BUTTONS_CODE = """<div id="shareNice" data-share-label#=""
#    data-color-scheme="black" data-icon-size="32" data-panel-bottom="plain"
...
# </ul>
#CONTENT_FOOTER = '<div id="shareNice" color-scheme="black" icon-size="32" share-label="Share this demo" panel-bottom="plain"></div>'
# </div>
...
*/
/* This has problems with tashdeed but works on mobile, sort of */
@font-face {
    font-family: "Fajer";
...
*/
html[lang="ur"] body {
    font-family: "Jameel Noori Nastaleeq", Fajer;
    font-size: 24px;
    font-stretch: normal;
}
.emoji {
...
<script>
  ...
  ga('create', 'UA-47551445-1', 'seanpue.com');
  ga('send', 'pageview');
